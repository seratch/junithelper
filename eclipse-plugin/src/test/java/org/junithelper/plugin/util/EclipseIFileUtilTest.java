...
public class EclipseIFileUtilTest extends TestCase {
    ...
    public void test_getDetectedCharsetFrom_A$IFile$String() throws Exception {
        // given
        IFile file = mock(IFile.class);
        String defaultCharset = "abc";
        // when
        String actual = EclipseIFileUtil.getDetectedCharsetFrom(file, defaultCharset);
        // then
        String expected = "abc";
        assertEquals(expected, actual);
    }
