...
public final class RegExp {
	...
	static {
		StaticMethodSignature = WhiteSpace.Consecutive_ZeroOrMore_Max
				+ "[<\\w+?>|final|\\s]*" + "static" + "[<\\w+?>|final|\\s]*"
				+ NotWhiteSpace.Consecutive_OneOrMore_Min
				+ WhiteSpace.Consecutive_OneOrMore_Max
				+ NotWhiteSpace.Consecutive_OneOrMore_Min
	...
	static {
		MethodArg_Group = NotWhiteSpace.Consecutive_OneOrMore_Min
				+ WhiteSpace.Consecutive_OneOrMore_Max + "("
				+ NotWhiteSpace.Consecutive_OneOrMore_Min + "$)";
	}
	...
	static {
		Package_Group = WhiteSpace.Consecutive_ZeroOrMore_Max + "package"
				+ WhiteSpace.Consecutive_OneOrMore_Max + "([^\\s]+)"
				+ WhiteSpace.Consecutive_ZeroOrMore_Max + ";"
				+ Anything_ZeroOrMore_Min;
	}

	public static final class PatternObject {

		public static Pattern MethodSignatureArea = Pattern
				.compile(RegExp.MethodSignatureArea);
		...
		public static Pattern MethodArg_Group = Pattern
				.compile(RegExp.MethodArg_Group);
		public static Pattern PackageDefArea_Group = Pattern
				.compile(RegExp.PackageDefArea_Group);
		public static Pattern Pacakge_Group = Pattern
				.compile(RegExp.Package_Group);
